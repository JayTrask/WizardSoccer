...
public class Player : NetworkBehaviour {
    ...
    private GameObject playerCheck; // used to check if player 1 has already been set on gameover object
    ...
    {
        playerCheck = scoreBoard.GetComponent<GameScore>().GameOverPlayer1;
        if (playerCheck == null)
        {
            playerCheck = gameObject;
        }
        else
        {
            scoreBoard.GetComponent<GameScore>().GameOverPlayer2 = gameObject;
        }
    }
	private void Start()
	{
